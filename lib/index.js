...
const { Passport, Extensions } = require('./extensions')
...
/**
  ...
  * @param {Array|String} AdditionalExt add addition files ext to required
  */
module.exports = berserkEngine = (
	...
	try {
		...
		if (configPath) {
			...
			if (PassportFile) PassportFile
			Passport(PassportFile)

			// Dynamic file ext
			if (AdditionalExt) Extensions(...AdditionalExt)
