...
module.exports = {
	...
	/**
	 * cookieSigned 
	 * @param {String} secret default cookie secret key
	 * @param {String} option default cookie option
	 */
	cookie: { secret: 'berserk-signed-cookie', option: '' },
